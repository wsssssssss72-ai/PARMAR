    ...
    <nav className="fixed top-0 left-0 right-0 h-16 bg-white/90 backdrop-blur-xl border-b border-slate-100 z-50 px-4 md:px-8">
      <div className="max-w-7xl mx-auto h-full flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          <span className="font-black text-slate-900 text-xl tracking-tighter">EduStream</span>
        </Link>
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end hidden sm:flex">
             ...
             <span className="text-[10px] font-bold text-green-500 uppercase tracking-widest">Premium Student</span>
          </div>
